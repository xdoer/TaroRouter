...
function getRouterList(path$1, exts, routerList, opt) {
  if (path$1 === void 0) {
    path$1 = '';
  }
  ...
  for (var _iterator = _createForOfIteratorHelperLoose(paths), _step; !(_step = _iterator()).done;) {
    ...
    if (/^pages$/.test(name)) {
      ...
      var _loop = function _loop() {
        ...
        var realFilePath = path$1 + "/pages/" + page + "/index";
    ...
    if (/^package-/.test(name)) {
      ...
      routerList = getRouterList(path.resolve(path$1, item), exts, routerList, _opt2);
    }
  }
...
function _saveSourceFile() {
  _saveSourceFile = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee(sourceFile) {
...
function generateRouterService(routerList, generateRouterServiceOpt) {
  ...
  for (var _iterator = _createForOfIteratorHelperLoose(routerList), _step; !(_step = _iterator()).done;) {
    var routerMeta = _step.value;
...
function modifyAppConfig(_x, _x2) {
  return _modifyAppConfig.apply(this, arguments);
}

function _modifyAppConfig() {
  _modifyAppConfig = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee(routerList, modifyAppConfigOpt) {
    var appConfigPath, routes, project, sourceFile, expAssign, objectLiteralExpression, pageInitializer, subPageInitializer;
    return runtime_1.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            appConfigPath = modifyAppConfigOpt.appConfigPath;
            /**
             * 构造 app.config.ts 中的路由项
             */

            routes = routerList.reduce(function (routerConfig, meta) {
              var pagePath = meta.path.slice(1);
              ...
              var _routerConfig$subPack = routerConfig.subPackages,
                  subPackages = _routerConfig$subPack === void 0 ? [] : _routerConfig$subPack;
              var subPackage = subPackages.find(function (subPackage) {
                var _subPackage;

                if (subPackage === void 0) {
                  subPackage = {};
                }

                return ((_subPackage = subPackage) == null ? void 0 : _subPackage.root) === meta["package"];
              });
              var subPagePath = pagePath.replace(/^package-\b\w+\b\//, "");

              if (subPackage) {
                subPackage.pages.push(subPagePath);
                return _extends({}, routerConfig, {
                  subPackages: subPackages
                });
              }

              var _ref = meta["package"].match(/^package-(\w+)$/) || [],
                  packageName = _ref[1];
            ...
            subPageInitializer = "[" + routes.subPackages.map(function (v) {
...
function checkAndAddProperty(name, node, initializer) {
  var _node$getProperty;

  ((_node$getProperty = node.getProperty(name)) == null ? void 0 : _node$getProperty.set({
    initializer: initializer
  ...
  _modifyProjectConfig = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee(routerList, modifyProjectConfig) {
    ...
    return runtime_1.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            projectConfigPath = modifyProjectConfig.projectConfigPath;
            ...
            if (!((_projectConfig$condit = projectConfig.condition) != null && _projectConfig$condit.miniprogram)) {
              projectConfig.condition.miniprogram = {};
            }

            if (!((_projectConfig$condit2 = projectConfig.condition) != null && (_projectConfig$condit3 = _projectConfig$condit2.miniprogram) != null && _projectConfig$condit3.list)) {
...
var index = (function (options) {
  ...
  var _resolveConfig = resolveConfig(routerConfig),
      ...
      _resolveConfig$naviga = _resolveConfig.navigateSpecifier,
      navigateSpecifier = _resolveConfig$naviga === void 0 ? '' : _resolveConfig$naviga,
  ...
  modifyProjectConfig(routerList, {
    projectConfigPath: projectConfigPath
  });
});

function resolveConfig(routerConfig) {
  var pageDir = routerConfig.pageDir,
...
//# sourceMappingURL=generated-plugin-taro-router-service.cjs.development.js.map
